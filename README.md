...
**pixelFree** 是一款支持全平台, 轻量级高性能的美颜特效 SDK，主要用于直播，短视频，证件照，照片处理.....

主要功能包含：相机调色，美颜，美型，美妆，2D 贴纸，绿幕背景替换…….
...
| 功能             | 子功能                                                       |
| ---------------- | ------------------------------------------------------------ |
| **基础美颜**     | **美白、磨皮、红润、锐化、亮眼、画质增强，去法令纹，去黑眼圈** |
| **滤镜**         | **50款 可选**                                                |
| **美型**         | **大眼、瘦脸、瘦颧骨、额头、下巴、瘦鼻、 瘦下颔、短脸、人中、长鼻、眼距、微笑嘴角、旋转眼睛、开眼角** |
| **一键美颜**     | **自然、可爱、女神、白净**                                   |
| **相机调色**     | **亮度,对比度,曝光,高光,阴影,饱和度,色温,色相全局 HLS, 根据关键色是调节** |
| **人脸贴**       | **60款 2D 贴纸可选**                                         |
| **绿幕背景替换** | **仅对绿幕背景扣除，背景替换 （不是人像分割）**              |
| **自定义水印**   | **输入水印图已和位置即可**                                   |
| ***美妆***       | **10款整装妆容，支持 眉毛、腮红、眼影、眼线、睫毛、唇彩、高光、阴影、粉底 程度调节** |
