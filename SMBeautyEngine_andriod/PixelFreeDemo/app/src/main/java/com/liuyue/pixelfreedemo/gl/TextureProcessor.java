...
public class TextureProcessor {
    ...
    private float[] mCustomMVP = new float[16];
    ...
    public void rotate(float degree, float x, float y, float z){
        Matrix.rotateM(mCustomMVP, 0, degree, x, y, z);
    }

    public void mirror(){
        Matrix.rotateM(mCustomMVP, 0,180,0f,1f,0f);
    }

    public void scale(float scaleX, float scaleY) {
        Matrix.scaleM(mCustomMVP, 0, scaleX, scaleY, 1f);
    }
    ...
    public int draw(int texId) {
        ...
        GLES20.glUniformMatrix4fv(mMVPMatrixLoc, 1, false, mCustomMVP, 0);
...
//        sendImage(mWidth,mHeight);
    ...
    private boolean setupShaders() {
        ...
        String fragmentShaderStr = ResourceUtils.loadStringFromResource(AppUtils.getApp(), R.raw.texture_2d_fs);
