...
PF_CAPI_EXPORT extern void
PF_pixelFreeSetBeautyFiterParam(PFPixelFree *pixelFree, PFBeautyFiterType key, void *value);

PF_CAPI_EXPORT extern void
PF_createBeautyItemFormBundle(PFPixelFree *pixelFree, void *data, int size, PFSrcType type);
