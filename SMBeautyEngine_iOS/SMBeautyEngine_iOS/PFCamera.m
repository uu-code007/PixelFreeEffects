...
typedef void(^PFCameraRecordVidepCompleted)(NSString *videoPath);

@interface PFCamera()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate>
{
    RunMode runMode;
    BOOL hasStarted;
...
@property (copy, nonatomic) PFCameraRecordVidepCompleted recordVidepCompleted;

@property (assign, nonatomic) AVCaptureSessionPreset mSessionPreset;

@property (nonatomic) PFCameraFocusModel cameraFocusModel;
@end
...
- (void)startCapture{
    _cameraFocusModel = PFCameraModelAutoFace;
...
- (void)subjectAreaDidChange:(NSNotification *)notification
{
    dispatch_async(self.videoCaptureQueue, ^{
        ...
        [self cameraChangeModle:PFCameraModelAutoFace];
    });
...
-(void)cameraFocusAndExpose{
    if (_cameraFocusModel == PFCameraModelAutoFace) {
...
-(void)cameraChangeModle:(PFCameraFocusModel)modle
{
