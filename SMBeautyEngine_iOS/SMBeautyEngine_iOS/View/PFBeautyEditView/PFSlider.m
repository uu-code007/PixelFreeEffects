...
-(void)layoutSubviews {
    ...
    if (!middleView) {
        middleView = [[UIView alloc] initWithFrame:CGRectMake(2, self.frame.size.height /2.0 - 2, 100, 5)];
    ...
    line.frame = CGRectMake(self.frame.size.width / 2.0, self.frame.size.height/2-4, 2.0,8) ;
