...
typedef NS_ENUM(NSInteger, PFBeautyEditViewModuleType) {
    PFBeautyEditViewModuleTypeNone       = -1,
    PFBeautyEditViewModuleTypeOneKey     = 0,
    PFBeautyEditViewModuleTypeSkin       = 1,
...
@interface PFBeautyEditView : UIView
...
@property (nonatomic, assign) id<PFBeautyEditViewDelegate>mDelegate ;
